...
module.exports = {
    ...
    module: {
        ...
        rules: [
            ...
            // 设置less文件的处理
            {
                test: /\.less$/,  //以.less结尾的文件都按照此规则处理
                use:[    //use的loader从下往上处理，所以执行顺序是less-loader->postcss-loader->css-loader->style-loader
                    "style-loader",
                    "css-loader",
                    // 引入postcss
                    {
                        ...
                        options:{
                            postcssOptions:{
                                plugins:[   //postcss-loader中的插件
                                    [
                                        "postcss-preset-env",  //postcss预置环境
                                        {
